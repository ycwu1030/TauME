...
// Thu Sep 12 09:44:44 2024 by ROOT version 6.30/06
// from TTree LHEF/Analysis tree
// found on file: dfRe_0x0.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("dfRe_0x0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("dfRe_0x0.root");
      }
