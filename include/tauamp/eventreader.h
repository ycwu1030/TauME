...
private:
    ...
    template <TauDecayMode_t modem, TauDecayMode_t modep>
    bool m_read_parton_event() {
        return false;
    }
    template <>
    bool m_read_parton_event<Pion, Pion>() {
        ...
        int n_beam_particle = m_branch_BeamParticle->GetEntriesFast();
        if (n_charged_pion != 2 || n_neutral_pion != 0 || n_neutrino != 2 || n_beam_particle != 2) return false;
    ...
    template <>
    bool m_read_parton_event<Rho, Rho>() {
        int n_charged_pion = m_branch_GenChargedPion->GetEntriesFast();
        int n_neutral_pion = m_branch_GenNeutralPion->GetEntriesFast();
        int n_neutrino = m_branch_GenNeutrino->GetEntriesFast();
        int n_beam_particle = m_branch_BeamParticle->GetEntriesFast();
    ...
    bool m_read_parton_level_event() { return m_read_parton_event<Mode_m, Mode_p>(); }
