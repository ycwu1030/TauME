...
class ME_EDM_Re_t : public ME_Base_t<TAUM_DECAY_t, TAUP_DECAY_t> {
    ...
    // * For only real part of the coefficient of the EDM operator
public:
    ME_EDM_Re_t() {}
    ~ME_EDM_Re_t() {}
...
template <class TAUM_DECAY_t, class TAUP_DECAY_t>
class ME_EDM_Im_t : public ME_Base_t<TAUM_DECAY_t, TAUP_DECAY_t> {
    // * For e+ e- > gamma* > tau+ tau-
    // * Including EDM operator between gamma and tau lepton
    // * For only imaginary part of the coefficient of the EDM operator
public:
    ME_EDM_Im_t() {}
    ~ME_EDM_Im_t() {}
...
protected:
    virtual void set_production_momenta(std::vector<dlv_t> p_list) override {
        ...
        cd_t M03 = -8 * SP04 * SP13 * SP22 - 8 * SP03 * SP14 * SP22 -
                   ...
                   8 * SP02 * SP13 * SP42;
        cd_t M11 = 0;
        cd_t M12 = 8 * (SP12 * SP34 * SP60 - 2 * SP13 * SP42 * SP60 + SP02 * SP34 * SP61 - 2 * SP03 * SP42 * SP61 +
                        2 * SP04 * SP13 * SP62 + 2 * SP03 * SP14 * SP62 - SP01 * SP34 * SP62 +
                        pow(MTAU, 2) * (SP12 * SP60 + SP02 * SP61 + SP01 * SP62) - SP04 * SP12 * SP63 -
                        SP02 * SP14 * SP63 + SP01 * SP42 * SP63);
        cd_t M13 = 0;
        cd_t M21 = 0;
        cd_t M22 = 8 * (-2 * SP14 * SP32 * SP50 + SP12 * SP34 * SP50 - 2 * SP04 * SP32 * SP51 + SP02 * SP34 * SP51 +
                        2 * SP04 * SP13 * SP52 + 2 * SP03 * SP14 * SP52 - SP01 * SP34 * SP52 +
                        pow(MTAU, 2) * (SP12 * SP50 + SP02 * SP51 + SP01 * SP52) - SP03 * SP12 * SP54 -
                        SP02 * SP13 * SP54 + SP01 * SP32 * SP54);
        cd_t M23 = 0;
        cd_t M31 = -8 * (SP04 * SP13 * SP56 + SP03 * SP14 * SP56 - SP01 * SP34 * SP56 + pow(MTAU, 2) * SP51 * SP60 +
                         SP34 * SP51 * SP60 - SP13 * SP54 * SP60 + pow(MTAU, 2) * SP50 * SP61 + SP34 * SP50 * SP61 -
                         SP03 * SP54 * SP61 - SP14 * SP50 * SP63 - SP04 * SP51 * SP63 + SP01 * SP54 * SP63);
